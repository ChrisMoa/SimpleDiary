...
class PinAuthenticationPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _PinAuthenticationPageState();
}
...
class _PinAuthenticationPageState extends ConsumerState<PinAuthenticationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Enter Pin', style: TextStyle(color: Theme.of(context).colorScheme.onPrimary)),
        ...
        child: Column(
          ...
          children: [
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  if (userData.username.isNotEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Incorrect pin', style: TextStyle(color: Theme.of(context).colorScheme.onError)), backgroundColor: Theme.of(context).colorScheme.error),
                    );
                  }
                }
              },
            ...
            TextButton(
              ...
              child: Text('Switch User', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
            ),
          ],
        ),
      ),
