...
final supabaseSettingsProvider =
   StateNotifierProvider<SupabaseSettingsNotifier, SupabaseSettings>((ref) {
 return SupabaseSettingsNotifier();
});

class SupabaseSettingsNotifier extends StateNotifier<SupabaseSettings> {
 SupabaseSettingsNotifier() : super(SupabaseSettings.empty());
...
class SupabaseSyncNotifier extends StateNotifier<SyncState> {
 ...
 SupabaseSyncNotifier(this.ref) 
     : super(SyncState(status: SyncStatus.idle, message: 'Ready to sync'));
