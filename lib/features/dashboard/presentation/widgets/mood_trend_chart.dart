...
///
/// Watches [weekOverviewProvider] instead of the full [dashboardStatsProvider]
/// so it only rebuilds when weekly scores change, not when unrelated stats
/// (streak, insights, etc.) update.
        ...
        return AppCard.elevated(
          ...
          child: Column(
              ...
              children: [
                ...
                SizedBox(
                  height: 200,
                  child: _buildLineChart(dailyScores, colorScheme, theme, l10n),
                ),
              ],
            ),
        );
