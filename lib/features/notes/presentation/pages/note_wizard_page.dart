...
import 'package:day_tracker/features/notes/presentation/widgets/notes_day_view_widget.dart';
import 'package:day_tracker/features/notes/presentation/widgets/notes_editing_wizard_widget.dart';
  ...
  bool isNotesOfSelectedDayFinished() {
    ...
    for (var curTime = dayBegin; curTime.isBefore(dayEnd);) {
      ...
      curTime = curTime.add(Duration(
          minutes:
              timeIncrease)); // Move to the next time slot directly at the end of the previous slot
    }
