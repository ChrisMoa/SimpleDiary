...
class ThemeProvider extends StateNotifier<ThemeData> {
  ThemeProvider()
      : super(lightTheme.copyWith(
          colorScheme: ColorScheme.fromSeed(
            brightness: settingsContainer.activeUserSettings.darkThemeMode ? Brightness.dark : Brightness.light,
  ...
  void updateThemeFromSeedColor(Color newThemeColor) {
    LogWrapper.logger.t('updates themeColor to ${Utils.colorToRGBInt(newThemeColor)}');
